          ...
          <Row>
            <Col lg="6">
              <div className="experience-content">
                ...
                <p>
                  Indulge in an immersive travel experience with us, where we curate every detail to offer you a seamless and unforgettable journey around the world, allowing you to explore and discover new cultures, cuisines, and
      ...
      <Container>
        <Row>
          <Col lg="12">
            ...
            <h2 className="galery-title">Visit our costumer tour gallery</h2>
          </Col>
          <Col lg="12">
